...
Renderer2D::Renderer2D(const char* title, int width, int height) : m_Impl(std::make_unique<Impl>()) {
...
void Renderer2D::Clear() {
    ...
    if (!SDL_SetRenderDrawColor(m_Impl->renderer.get(), m_Impl->clearColor.r, m_Impl->clearColor.g,
